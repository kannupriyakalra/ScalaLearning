...
object TestZip extends App {
  ...
  def zipEithers(e1: Either[Int, String], e2: Either[Int, String]): Option[Either[(Int, Int), (String, String)]] = {
  ...
  println(zipEithers(Left(10), Left(10)))
  println(zipEithers(Left(10), Right("abc")))
  println(zipEithers(Right("abc"), Left(10)))
  println(zipEithers(Right("abc"), Right("abc")))
