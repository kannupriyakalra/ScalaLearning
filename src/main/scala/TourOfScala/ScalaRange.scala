...
scala> (0 to 50).toSet ++ (0 to 49).toSet
val res0: Set[Int] = HashSet(0, 5, 10, 14, 1, 6, 9, 2, 8, 4, 42, 24, 37, 25, 20, 46, 29, 21, 33, 28, 38, 13, 41, 45, 17, 32, 34, 22, 44, 27, 12, 49, 7, 39, 3, 35, 48, 18, 50, 16, 31, 11, 43, 40, 26, 23, 36, 30, 19, 47, 15)

scala> (0 to 50).toSet -- (0 to 49).toSet
val res1: Set[Int] = HashSet(50)
