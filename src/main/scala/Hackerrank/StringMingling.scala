...
//      mingledStrings(p.tail, q.tail, finalString + s"${p.head}${q.head}")
//    }

  //why is it Terminated due to timeout for big i/p when it is tail recursive?-----------------chatgpt couldnt tell
